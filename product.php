    ...
    <section class="content container-fluid">
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <a href="add_product.php" class="btn btn-success btn-sm pull-right">เพิ่มสินค้า</a>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-striped" id="myProduct">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td><?php echo number_format($row->purchase_price);?> บาท</td>
                                <td><?php echo number_format($row->sell_price); ?> บาท</td>
