    ...
    if(isset($_POST['save_order'])){
      ...
      if($arr_product_code == ""){
        echo '<script type="text/javascript">
              ...
              swal("คำเตือน", "กรุณากรอกแบบฟอร์มการสั่งสินค้า", "warning", {
              button: "Continue",
                  });
              });
              </script>';
        ...
        if($invoice_id!=null){
          for($i=0; $i<count($arr_product_id); $i++){
            ...
            if($rem_qty<0){
              echo '<script type="text/javascript">
                    jQuery(function validation(){
                    swal("คำเตือน", "ป้อนจำนวนเงินที่ซื้อ", "warning", {
                    button: "Continue",
                        });
                    });
                    </script>';
            ...
            values(:invoice_id, :product_id, :product_code, :product_name, :qty, :price, :total, :order_date)");

            $insert->bindParam(':invoice_id',  $invoice_id);
            $insert->bindParam(':product_id',   $arr_product_id[$i]);
            $insert->bindParam(':product_code',   $arr_product_code[$i]);
        ...
        <div class="box box-success">
          <form action="" method="POST">
            <div class="box-body">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>วันที่ทำการสั่งสินค้า</label>
                  <div class="input-group">
                    <div class="input-group-addon">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>ชั่วโมงที่ทำการสั่งสินค้า</label>
                  <div class="input-group">
                    <div class="input-group-addon">
            ...
            <div class="box-body">
              <div class="col-md-offset-1 col-md-10">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      <span><?php echo $_SESSION['invoice_id']; ?> บาท</span>
                    </div>
            ...
            <div class="box-footer" align="center">
              <input type="submit" name="save_order" value="บันทึกคำสั่งซื้อ" class="btn btn-success">
    ...
    $(document).ready(function(){
      ...
      $("#myOrder").delegate(".quantity_product","keyup change", function(){
        ...
        if((quantity.val()-0)>(tr.find(".productstock").val()-0)){
          swal("คำเตือน","สินค้าไม่เพียงพอ","warning");
          quantity.val(1);
