...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Store|</b>POS</a>
  </div>
  <!-- /.login-logo -->
      ...
      <?php
        if(!empty($message)){
          echo'<script type="text/javascript">
              ...
              swal("เข้าสู่ระบบสำเร็จ", "สวัสดีคุณ  '.$_SESSION['role'].'", "success", {
              button: "ต่อไป",
                });
              });
              </script>';
        ...
        if(empty($errormsg)){
          ...
          echo'<script type="text/javascript">
              jQuery(function validation(){
              swal("เข้าสู่ระบบไม่สำเร็จ", "ชื่อผู้ใช้ หรือ รหัสผ่าน ผิดพลาด", "error", {
              button: "ต่อไป",
                });
              });
          </script>';
