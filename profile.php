  ...
  if($_SESSION['username']==""){
    ...
    if(isset($_POST['btn_update'])){
        ...
        if($oldpass == $password_db){
          ...
          //if values match update the password
           ...
           if($update->execute()){
              ...
              jQuery(function validation(){
                swal("สำเร็จ", "เปลี่ยนรหัสผ่านแล้ว", "success", {
                  button: "ต่อไป",
                });
              });
              </script>';
              ...
              echo'<script type="text/javascript">
              jQuery(function validation(){
                swal("อุ๊ปส์", "รหัสผ่านยังไม่ได้เปลี่ยน", "error", {
                  button: "ต่อไป",
                });
              });
              </script>';
            ...
            echo'<script type="text/javascript">
            jQuery(function validation(){
              swal("คำเตือน", "ยืนยันรหัสผ่าน ผิด", "warning", {
                button: "ต่อไป",
              });
            });
            </script>';
          ...
          echo'<script type="text/javascript">
          jQuery(function validation(){
            swal("Warning", "รหัสผ่านไม่ถูกต้อง", "warning", {
              button: "Continue",
            });
          });
          </script>';
    ...
    <section class="content container-fluid">
          ...
          <div class="box box-primary">
            ...
            <form action="" method="POST">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="btn_update">อัปเดท</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="col-md-8">
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">ประวัติผู้ใช้</h3>
            </div>
            <!-- /.box-header -->
            <?php
                $id = $_SESSION['user_id'];
            ...
            <div class="box-body">
              <div class='detail-text'>
                  <label for="name"><strong>ชื่อผู้ใช้:</strong></label>
                  <span class='text-data'> <?php echo $row->username; ?></span><br>
                  <label for="name"><strong>ชื่อเต็ม:</strong></label>
                  <span class='text-data'> <?php echo $row->fullname; ?></span><br>
                  <label for="name"><strong>ตำแหน่ง:</strong></label>
                  <span class='text-data'> <?php echo $row->role; ?></span><br>
                  <label for="name"><strong>รหัสผ่าน:</strong></label>
