                ...
                if($img_ext == 'jpg' || $img_ext == 'jpeg' || $img_ext == 'png' || $img_ext == 'gif'){
                    if($img_size>= 1000000){
                        $error ='<script type="text/javascript">
                                ...
                                swal("ผิดพลาด", "ไฟล์ต้องมีขนาด 1MB", "error", {
                                button: "ต่อไป",
                                    });
                                });
                                </script>';
                    ...
                    $error = '<script type="text/javascript">
                    jQuery(function validation(){
                    swal("ผิดพลาด", "กรุณาอัพโหลดรูปภาพในรูปแบบ: jpg, jpeg, png, gif", "error", {
                    button: "จ่อไป",
                        });
                    });
                    </script>';
            ...
            <form action="" method="POST" name="form_product"
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="">สินค้าคงคลังขั้นต่ำ</label>
                            <input type="number" min="1" step="1"
                ...
                <div class="box-footer">
                    ...
                    name="update_product">อัปเดทสินค้า</button>
                    <a href="product.php" class="btn btn-warning">กลับมา</a>
                </div>
            </form>
